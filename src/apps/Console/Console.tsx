...
function reducer(state: ConsoleState, action: Action): ConsoleState {
  switch (action.type) {
    ...
    case "START_CONFIRM":
      return {
        ...state,
        confirm: { pending: true, perform: action.perform, restorePrompt: action.restorePrompt },
      };
    case "END_CONFIRM":
...
export const Console: React.FC = () => {
  ...
  const [duckModeActivatedAt, setDuckModeActivatedAt] = React.useState<number | null>(null);
  ...
  const handlers = useMemo(
    ...
    [duckCount, duckMode, duckModeActivatedAt]
  );
  ...
  }, [instance, ref, printLines, runCommand, writePrompt]);
